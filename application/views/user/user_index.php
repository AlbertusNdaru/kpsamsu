...
<head>
  ...
  <link href="<?php echo base_url_shop()?>css/bootstrap.css" rel="stylesheet" type="text/css" media="all">
  <!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
  <script src="<?php echo base_url_shop()?>js/jquery-1.11.0.min.js"></script>
  <!-- Custom Theme files -->
  <link href="<?php echo base_url_shop()?>css/style.css" rel="stylesheet" type="text/css" media="all"/>
  <!-- Custom Theme files -->
  ...
  <!-- <script type="text/javascript" src="<?php echo base_url_shop()?>js/move-top.js"></script>
  <script type="text/javascript" src="<?php echo base_url_shop()?>js/easing.js"></script> -->
	              ...
	              <nav class="navbar navbar-default" role="navigation">
					    <div class="navbar-header">
					        ...
					        <div class="navbar-brand logo">
								<a href="index.html"><img src="<?php echo base_url_shop()?>images/logo1.png" alt=""></a>
							</div>
					    </div>
					    <!--/.navbar-header-->
		...
		<div class="blc-layer3-main">
			   ...
			   <div class="col-md-4 blc-layer3-grids-3 simpleCart_shelfItem">
				 <div class="box-grid">
				   	...
				   	<a href="single.html"><img src="<?php echo base_url_shop()?>images/w2.png" alt=""></a>
	...
	<div class="container">
		<div class="home-block-main">
			<div class="col-md-3 home-grid">
				<div class="home-product-main">
				   <div class="home-product-top">
				      <a href="product.html"><img src="<?php echo base_url_shop()?>images/h1.jpg" alt="" class="img-responsive zoom-img"></a>
				   </div>
			...
			<div class="col-md-3 home-grid">
				<div class="home-product-main">
				   <div class="home-product-top">
				      <a href="product.html"><img src="<?php echo base_url_shop()?>images/h2.jpg" alt="" class="img-responsive zoom-img"></a>
				   </div>
					<div class="home-product-bottom">
							<h3><a href="single.html">Smart Shopping</a></h3>
							<p>Explore Now</p>						
			...
			<div class="col-md-3 home-grid">
				<div class="home-product-main">
				   <div class="home-product-top">
				      <a href="product.html"><img src="<?php echo base_url_shop()?>images/h3.jpg" alt="" class="img-responsive zoom-img"></a>
				   </div>
					<div class="home-product-bottom">
							<h3><a href="single.html">Smart Shopping</a></h3>
							<p>Explore Now</p>						
			...
			<div class="col-md-3 home-grid">
				<div class="home-product-main">
				   <div class="home-product-top">
				      <a href="product.html"><img src="<?php echo base_url_shop()?>images/h4.jpg" alt="" class="img-responsive zoom-img"></a>
				   </div>
					<div class="home-product-bottom">
							<h3><a href="single.html">Smart Shopping</a></h3>
							<p>Explore Now</p>						
